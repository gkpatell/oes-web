...
export default function QuantumInitiativePage() {
  return (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl font-light mb-6">About Quantum Initiative</h2>
              <p className="text-lg mb-6">
                [Information about Quantum Initiative and its activities in the O'Connor Building will be added here]
              </p>
            </div>
            ...
            <div className="text-center">
              <Button asChild>
                <Link href="https://quantum.rice.edu" target="_blank" rel="noopener noreferrer">
                  Visit Quantum Initiative Website
                </Link>
              </Button>
            </div>
          </div>
