...
export default function MSNEDepartmentPage() {
  return (
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent">
          <div className="container mx-auto h-full flex flex-col justify-end pb-16 px-4">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-2xl mb-8">
              Exploring the frontiers of materials science and nanotechnology.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="mb-12">
              <h2 className="text-3xl font-light mb-6">About MSNE</h2>
              <p className="text-lg mb-6">
                [Information about MSNE and its activities in the O'Connor Building will be added here]
              </p>
            </div>
            ...
            <div className="text-center">
              <Button asChild>
                <Link href="https://msne.rice.edu" target="_blank" rel="noopener noreferrer">
                  Visit MSNE Website
                </Link>
              </Button>
            </div>
